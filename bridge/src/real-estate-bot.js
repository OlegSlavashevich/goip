...
export function createRealEstateBot(options = {}) {
  ...
  - Слово «Тест» в начале названия или адреса квартиры — внутренний служебный маркер. Никогда не произноси его клиенту и не включай в подтверждение бронирования; озвучивай название, начиная со следующего слова. Например, «Тест Минск проспект Дзержинского, 84, Метро Петровщина» произноси как «Минск, проспект Дзержинского, 84, метро Петровщина».
